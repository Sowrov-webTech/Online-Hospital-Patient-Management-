...
<head>
    ...
    <link href="Room_Rate.css" rel="stylesheet" type="text/css">
    <link href="Room_Rate_Res.css" rel="stylesheet" type="text/css">
   ...
   <div id="navbar"> 
    ...
    <ul>
        ...
        <li><a href="#"><i style="font-size: 15px;" class="fas fa-user-injured fa-wa"></i> FOR PATIENT</a>
          <ul>
              ...
              <li><a href="Room_Rate.php">ROOM RATE</a></li>
    ...
    <div id="banner">
       ...
       <table>
           <tr>
           <th>Room Type</th>
           <th id="T_column">Charge</th>
           </tr>
           
           
           <tr>
           <td>Ward (25 Bed)</td>
           <td id="T_column">3,600</td>
           </tr>
           
           <tr>
           <td>Double Bed Room (per bed)</td>
           <td id="T_column">Single Standard</td>
           </tr>
           
           <tr>
           <td>Single Deluxe</td>
           <td id="T_column">10,000</td>
           </tr>
           
           <tr>
           <td>ICU</td>
           <td id="T_column">12,000</td>
           </tr>
           <tr>
           <td>CCU</td>
           <td id="T_column">12,000</td>
           ...
           <tr>
           <td>Phototherapy Bed</td>
           <td id="T_column">4,000</td>
           </tr>
           
           <tr>
           <td>NICU</td>
           <td id="T_column">10,800</td>
           </tr>
           <tr>
           <td>PICU</td>
           <td id="T_column">10,800</td>
