...
move_uploaded_file($tempname,$folder);
    ...
    $query="INSERT INTO staff VALUES('$username','$name','$gender','$dob','$blood','$email','$phone','$password','$address','$folder')";

$data=mysqli_query($conn,$query); 
      
	  
$query1="INSERT INTO login VALUES('$username','$password','staff')";
