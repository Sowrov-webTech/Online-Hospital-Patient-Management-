...
<?php
	...
	if(isset($_POST['search'])){
		...
		$userQuery=$connection->Search($conobj,"doctor",$searchFor);
	}
    else{
        	$userQuery=$connection->All($conobj,"doctor");
        	$searchFor = "";
        }
...
<head>
	...
	<link rel="stylesheet" href="doctor_table.css">
								...
								<?php
									while($row = mysqli_fetch_assoc($userQuery))
									{
										echo "<tr>
												...
												<td><a href='schedule.php?u_name=$row[username] & nm=$row[name] '>Assign</a></td>
