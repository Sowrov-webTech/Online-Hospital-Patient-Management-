...
<label >UserName:</label><br> 
     <input type="text" name="username" value="" id="username" onblur="username_checking()" placeholder="further not editable"><br><span id="username_msg"></span><br>
 <label >Name:</label><br>
...
<script type="text/javascript" src="Reg_form_validation.js"></script>
</body>
</html>