...
$j= $_GET["img"];
/*
<input type="text" name="blood" id="blood" value="<?php echo $d; ?>" onblur="blood_checking()"><br><span id="blood_msg"></span><br>
*/
?>
...
<label >Blood Group:</label><br>
    ...
    <select name="blood" id="blood" onblur="blood_checking()">
          ...
          <option value="A-" <?php if($d=="A- "){echo "selected";} ?>>A-</option> 
        <option value="AB+" <?php if($d=="AB  "){echo "selected";} ?>>AB+</option>
         <option value="AB+" <?php if($d=="AB- "){echo "selected";} ?>>AB-</option>       
          <option value="O+" <?php if($d=="O  "){echo "selected";} ?>>O+</option>
        <option value="O-" <?php if($d=="O- "){echo "selected";} ?>>O-</option>
...
<label >DOB:</label><br>
    <input type="textd" name="dob" id="dob" value="<?php echo $e; ?>" onblur="dob_checking()"><br><span id="dob_msg"></span><br>
<label >Phone Number:</label><br>
  <input type="text" name="phone" id="phone" value="<?php echo $g; ?>" onblur="phone_checking()"><br><span id="phone_msg"></span><br>
<label >Email:</label><br>
   <input type="email" name="email" id="email" value="<?php echo $h; ?>" onblur="email_checking()"><br><span id="email_msg"></span><br>
<label >Address:</label><br>
       <textarea name="address" id="address" rows="5" cols="10" value="" onblur="address_checking()"><?php echo $i; ?></textarea><br><span id="address_msg"></span><br>
...
<script type="text/javascript" src="FormUpdateValidation.js"></script>
...
/*$filename=$_FILES["uploadfile"]["name"]; // have to try use it as a function
